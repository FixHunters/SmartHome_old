...
public class MenuBars extends VerticalLayout implements View {
    ...
    public MenuBar getMenuButton(String caption, boolean splitButton) {
        MenuBar split = new MenuBar();
        MenuBar.MenuItem dropdown = split.addItem(caption, null);
        if (splitButton) {
            dropdown = split.addItem("", null);
        }
        dropdown.addItem("Working room", null);
        dropdown.addItem("Bed room", null);
        dropdown.addItem("Living room", null);
        dropdown.addItem("Bath room", null);
        dropdown.addSeparator();
        dropdown.addItem("Kitchen", null);
        dropdown.addItem("Toilet", null);
        dropdown.addItem("Balcony", null);
        dropdown.addItem("Hall", null);
